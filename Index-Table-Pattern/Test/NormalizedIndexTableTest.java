...
public class NormalizedIndexTableTest {
    ...
    public void insertSingleIntoPrimaryTable(){
        ...
        TableManager tableManager = new NormalizedIndexTable(primaryTable);
    ...
    public void createSecondaryTable(){
        ...
        assertTrue(tableManager.getDataByKey("Town: Chicago").size() == 3
                && tableManager.getDataByKey("Town: Chicago").containsAll(Arrays.asList(new Data("5","Customer_ID: 5,LastName: Smith,Town: Chicago"),new Data("9","Customer_ID: 9,LastName: Jones,Town: Chicago"),new Data("1000","Customer_ID: 1000,LastName: Clarke,Town: Chicago")))
    ...
    public void insertTestOnSecondaryTable(){
        ...
        primaryTable.insertData(new Data("10","Customer_ID: 10,LastName: Parker,Town: NewYork"));
